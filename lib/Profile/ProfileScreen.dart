...
import 'package:voice_craft/Profile/ProfileImagePickerScreen.dart';
import 'package:provider/provider.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:url_launcher/url_launcher.dart';

import '../../Provider/login_sharedpreference_provider.dart';
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  bool passToggle_email = true;
  bool passToggle_newpass = true;
...
// When signing up, allow user to pick an image
  late File _image;
  ...
  Future<String> _uploadImageToStorage() async {
    if (_image != null) {
      final storageRef = FirebaseStorage.instance
          .ref('profilePictures/${emailController.text}');
 ...
 if (userData.containsKey('Name')) {
  ...
  Widget build(BuildContext context) {
        final loginProvider = Provider.of<LoginSharedPreferenceProvider>(context, listen: false);
          ...
          children: [
            ...
            Column(
              children: [
                ...
                InkWell(
                    onTap: () async { signOutUser();
                    loginProvider.getBoolLogin = false;
SharedPreferences pref = await SharedPreferences.getInstance();
await pref.setBool("Login", loginProvider.getBoolLogin);
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      suffixIcon: InkWell(
                        onTap: () {
                          setState(() {
                            passToggle_email = !passToggle_email;
                          });
                        },
                        child: Icon(
                          passToggle_email
